...
--
-- Host: 127.0.0.1:7733
-- Generation Time: Jan 01, 2021 at 07:29 PM
...
(1, 'client1', '$2a$10$Yb8dkozATOxs098B0TcgmuDJQ7HeVVLQAgRAImzRgfifyXN2uHTzC', 'http://localhost:9090', 43200, 43200, '', 1);
...
INSERT INTO `usuario` (`id_user`, `username`, `email`, `password`, `rol_fk`, `descripcion`) VALUES
(1, 'admin', 'admin@gmail.com', '$2a$10$zIKF8VhNupV5BEBqAnksf.OExvQCNJJmQxbhKqN4nDkAXHSo4qOCW', 3, 'asdasdasdasdasd'),
(6, '123', '123@gmail.com', '$2a$10$mA8hsn8l7xv1mHpWeBauo.AFM9d.c5dDtXn/WhtbAdd06rEG/yZWS', 1, '');
